...
public class HibernateCategoryExtension extends AbstractCategoryExtension {

    public static final ExtensionContext.Namespace NAMESPACE = ExtensionContext.Namespace.create(HibernateCategoryExtension.class);
    ...
    public void beforeEach(ExtensionContext extensionContext) {
        UserJson testUser = extensionContext.getStore(HibernateCreateUserExtension.NAMESPACE).get("testUser", UserJson.class);
